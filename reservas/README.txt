...
a persistence unit "reservasPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/uy/edu/fing/tse/core/reservas/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "reservas/pom.xml":
...
artifacts ("reservas-ejb.jar" and "reservas-web.war") are already built. You can build
