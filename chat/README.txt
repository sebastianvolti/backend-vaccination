...
a persistence unit "chatPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "chat\pom.xml":
...
artifacts ("chat-ejb.jar" and "chat-web.war") are already built. You can build
