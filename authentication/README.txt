...
a persistence unit "authenticationPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/core/authentication/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "authentication/pom.xml":
...
artifacts ("authentication-ejb.jar" and "authentication-web.war") are already built. You can build
